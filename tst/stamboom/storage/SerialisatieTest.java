...
public class SerialisatieTest extends TestCase {
    ...
    public void testOpslag() {
        ...
        assertEquals("nummering van personen onjuist", adm.aantalGeregistreerdePersonen(), jan.getNr()); //Question
        Gezin rosaEnJan = adm2.addOngehuwdGezin(rosa, jan);
        assertEquals("nummering van gezinnen onjuist", adm.aantalGeregistreerdeGezinnen(), rosaEnJan.getNr()); //Question
